      ...
      <div className="mx-auto max-w-4xl space-y-10 px-4 pt-10 sm:px-6 lg:px-8">
        <header className="space-y-4 text-center">
          ...
          <p className="text-sm text-[color:var(--text-muted)] sm:text-base">
            This Privacy Policy explains how Gentlegurls collects, uses, and protects your personal information when
            you book services with us.
          </p>
        </header>
        ...
        <section className="grid gap-6">
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]/80 p-6 shadow-[0_20px_60px_-45px_rgba(15,23,42,0.5)] backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[color:var(--text-muted)] sm:text-base">
              We only collect the information needed for account registration, appointment booking, and service
              fulfilment. The information we gather is voluntarily submitted by customers when registering or making a
              booking.
            </p>
          </article>
          ...
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]/80 p-6 shadow-[0_20px_60px_-45px_rgba(15,23,42,0.5)] backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[color:var(--text-muted)] sm:text-base">
              Your personal details are used to manage appointments, customize your profile, comply with legal
              requirements, send booking confirmations and reminders, and share relevant updates, promotions, and events
              from Gentlegurls.
            </p>
          </article>
          ...
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]/80 p-6 shadow-[0_20px_60px_-45px_rgba(15,23,42,0.5)] backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[color:var(--text-muted)] sm:text-base">
              Gentlegurls accepts payments via Billplz and manual bank transfer. We do not store your full card or
              banking details on our servers. Payment information is handled through secure payment channels.
            </p>
          </article>
          ...
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]/80 p-6 shadow-[0_20px_60px_-45px_rgba(15,23,42,0.5)] backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[color:var(--text-muted)] sm:text-base">
              ...
              without your consent, except when required by law or to fulfil your booking.
            </p>
          </article>
          ...
          <article className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]/80 p-6 shadow-[0_20px_60px_-45px_rgba(15,23,42,0.5)] backdrop-blur">
            ...
            <p className="mt-3 text-sm text-[color:var(--text-muted)] sm:text-base">
              We apply appropriate security measures to protect customer data from unauthorized access, illegal
              disclosure, and misuse. However, information transmitted over the internet cannot be guaranteed 100%
              secure.
            </p>
          </article>
