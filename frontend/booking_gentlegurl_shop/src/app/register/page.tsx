...
function RegisterPageContent() {
  ...
  useEffect(() => {
    // Booking registration doesn't auto-login; only redirect if already logged in.
          ...
          <div className="w-full max-w-md">
            <div className="mb-6 text-center">
              ...
              <p className="mt-2 text-sm text-[var(--foreground)]/70">
                {successEmail ? "We’ve sent a verification email to your inbox." : "Join to manage your bookings faster."}
              </p>
            </div>
              ...
              {successEmail ? (
                <div className="space-y-5 text-sm text-[var(--foreground)]/80">
                  <div className="rounded-2xl border border-[var(--status-success-border)] bg-[var(--status-success-bg)] px-4 py-3 text-[color:var(--status-success)]">
                    We’ve sent a verification email to <strong>{successEmail}</strong>. Please verify to continue.
                  </div>
                  {resendMessage ? (
                ...
                <>
                  ...
                  <div className="mt-6 text-center text-sm text-[var(--foreground)]/70">
                    ...
                    <Link href={loginHref} className="font-medium text-[var(--accent-strong)] hover:opacity-80">
                      Sign in →
                    </Link>
                  </div>
                </>
