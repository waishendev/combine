      ...
      try {
        ...
        if (reward.type === "product") {
          ...
          setRedeemModal({
            ...
            description: reward.title ? `${reward.title} has been added to your cart.` : "Item added to your cart.",
            rewardType: "product",
            details: [
              ...(reward.title ? [{ label: "Reward", value: reward.title }] : []),
              { label: "Points Used", value: `${reward.points_required.toLocaleString()} pts` },
            ],
          });
        } else if (reward.type === "voucher") {
          const benefit = reward.voucher
          ...
          setRedeemModal({
            ...
            rewardType: "voucher",
            details: [
              ...(benefit ? [{ label: "Benefit", value: benefit }] : []),
