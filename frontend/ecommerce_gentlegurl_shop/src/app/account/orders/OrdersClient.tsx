  ...
  return (
    <div className="space-y-4">
      ...
      {orders.map((order) => {
        ...
        const isPendingUnpaid = statusKey === "pending" && paymentStatusValue === "unpaid" && !isExpired;
        ...
        return (
          ...
          >
            ...
            <div className="mt-4 grid gap-3 text-sm text-[var(--foreground)]/80 sm:grid-cols-4">
              ...
              {(canPayBillplz || canUploadSlip || statusKey === "cancelled" || isExpired) && (
      ...
      {slipOrderId && (
        <div
          ...
          onMouseDown={(e) => {
            if (e.target === e.currentTarget) setSlipOrderId(null);
          }}
        >
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">Order #{slipOrderId}</p>
              </div>
              <button
                type="button"
                onClick={() => setSlipOrderId(null)}
