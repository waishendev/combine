        ...
        <div className="pos-appt-month-scroll min-h-0 flex-1 rounded-lg border border-slate-200 bg-white p-2 shadow-sm sm:p-3">
          ...
          {appointmentsLoading ? (
            <div
              role="status"
              aria-live="polite"
              className="flex min-h-[20rem] flex-col items-center justify-center gap-3 rounded-md border border-dashed border-slate-200 bg-slate-50 px-4 py-10"
            >
