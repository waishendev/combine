...
import SalesVisualDailyDashboardWithNav from '@/components/reports/SalesVisualDailyDashboardWithNav'
...
export default function SalesVisualWorkspaceClientWithDateNav({ canExport }: { canExport: boolean }) {
  ...
  return (
    <div className="overflow-y-auto py-6 px-6 lg:px-10">
      ...
      <SalesVisualDailyDashboardWithNav mode={mode} />
