...
import BookingAppointmentFilters, {
  BookingAppointmentFilterValues,
  bookingAppointmentFiltersFormId,
...
interface Props {
  inputs: BookingAppointmentFilterValues
...
export default function BookingAppointmentFiltersWrapper({
  inputs,
  onChange,
  onSubmit,
  onReset,
  ...
  const handleSubmit = (values: BookingAppointmentFilterValues) => {
    onSubmit(values)
    onClose()
  }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-xl mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div className="flex items-center justify-between border-t border-gray-300 px-5 py-3">
          <button
            type="reset"
            form={bookingAppointmentFiltersFormId}
