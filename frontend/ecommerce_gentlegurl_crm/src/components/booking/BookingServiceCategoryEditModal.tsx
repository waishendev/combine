...
export default function BookingServiceCategoryEditModal({
  ...
  return (
      ...
      footer={
        !loading ? (
          <>
            ...
            <button
              type="submit"
              form="booking-service-category-edit-form"
    ...
    >
      <form id="booking-service-category-edit-form" onSubmit={handleSubmit} className="px-5 py-4">
        {loading ? (
          ...
          <>
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
              ...
              <div className="min-w-0 flex-1 space-y-4">
                ...
                <div>
                  <label htmlFor="edit-category-status" className="mb-1 block text-sm font-medium text-gray-700">
                    {t('common.status')}
                  </label>
                  <select
