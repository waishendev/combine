...
export default function BookingProductCategoryDeleteModal({ category, onClose, onSuccess }: Props) {
  const { t } = useI18n()
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
        ...
        <p className="text-sm text-gray-700">
          Are you sure you want to delete this category? Booking products using it will have their category cleared.
        </p>
        ...
        {error && (
          <div className="mt-4 rounded border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-600">{error}</div>
        )}
