...
export default function CategoryDeleteModal({
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(`/api/proxy/ecommerce/categories/${category.id}`, {
        method: 'DELETE',
        headers: {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div className="px-5 py-4 space-y-4">
          <p className="text-sm text-gray-700">Are you sure you want to delete this category? This action cannot be undone.</p>
