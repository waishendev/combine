    ...
    <div className="space-y-6 bg-gray-50 min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        <div className="grid auto-rows-fr gap-5">
          ...
          <div className="h-full rounded-xl border-2 border-gray-200 bg-white p-5 shadow-md">
          ...
          <div className="h-full min-h-0 rounded-xl border-2 border-gray-200 bg-white p-6 shadow-md flex flex-col">
        ...
        <div className="grid auto-rows-fr gap-5">
          ...
          <div className="h-full rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="h-full min-h-0 rounded-xl border-2 border-gray-200 bg-white p-5 shadow-md flex flex-col">
