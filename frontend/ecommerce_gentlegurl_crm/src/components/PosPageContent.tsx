    ...
    <div className="min-h-screen space-y-4 bg-gray-50 p-3 sm:space-y-5 sm:p-4 lg:space-y-6 lg:p-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-5 md:gap-5 md:min-h-0">
        <div className="space-y-4 md:col-span-3 md:space-y-5 md:min-h-0">
          ...
          <div className="flex min-h-[480px] flex-col rounded-xl border-2 border-gray-200 bg-white p-4 shadow-md sm:p-5 md:h-[calc(100vh-11rem)] md:min-h-0 lg:h-[calc(100vh-10rem)]">
            ...
            {/* Products Grid */}
            <div className="grid min-h-[300px] flex-1 grid-cols-1 gap-3 overflow-auto p-1 sm:grid-cols-2 md:min-h-0 md:grid-cols-2">
        ...
        <div className="space-y-4 md:col-span-2 md:space-y-5 md:min-h-0">
          ...
          <div className="flex min-h-[180px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-4 shadow-sm sm:p-5 md:h-[180px]">
            ...
            {cart?.items.length ? (
              <div className="mt-3 min-h-[260px] flex-1 space-y-3 overflow-y-auto pr-1 md:min-h-0">
                {cart.items.map((item) => (
