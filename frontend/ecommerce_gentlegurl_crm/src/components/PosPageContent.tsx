...
export default function PosPageContent() {
  ...
  return (
    <div className="space-y-6 bg-gray-50 min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 gap-5 xl:min-h-[calc(100vh-12rem)] xl:grid-cols-2 xl:[grid-template-rows:auto_minmax(0,1fr)] xl:items-stretch">
        <div className="contents">
          {/* Barcode Scanner Input - moved into left column above Products for better POS flow */}
          <div className="h-full rounded-xl border-2 border-gray-200 bg-white p-5 shadow-md xl:col-start-1 xl:row-start-1">
          ...
          <div className="h-full min-h-0 rounded-xl border-2 border-gray-200 bg-white p-6 shadow-md flex flex-col xl:col-start-1 xl:row-start-2">
            ...
            {/* Products Grid */}
            <div className="grid flex-1 min-h-0 grid-cols-2 gap-4 overflow-auto p-1 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="contents">
          ...
          <div className="h-full rounded-xl border border-gray-200 bg-white p-5 shadow-sm xl:col-start-2 xl:row-start-1">
            ...
            <div className="h-full min-h-0 rounded-xl border-2 border-gray-200 bg-white p-5 shadow-md flex flex-col xl:col-start-2 xl:row-start-2">
