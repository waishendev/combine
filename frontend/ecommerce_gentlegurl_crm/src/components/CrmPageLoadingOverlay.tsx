...
type CrmPageLoadingOverlayProps = {
  message?: string
}

export default function CrmPageLoadingOverlay({
  message = 'Loading details…',
}: CrmPageLoadingOverlayProps) {
  return (
    <div
      className="fixed inset-0 z-[60] flex items-center justify-center bg-gradient-to-b from-slate-100/90 via-slate-50/85 to-slate-100/90 px-4 backdrop-blur-[2px]"
      role="status"
      aria-live="polite"
      aria-busy="true"
    >
