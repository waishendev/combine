  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const payload = {
        ...
        product_id: form.type === 'product' ? productId : null,
        voucher_id: form.type === 'voucher' ? voucherId : null,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-xl mx-auto bg-white rounded-lg shadow-lg">
        <div className="flex items-center justify-between border-b border-gray-300 px-5 py-4">
          <h2 className="text-lg font-semibold">Edit Reward</h2>
          <button
            onClick={() => {
              if (!submitting) onClose()
            }}
