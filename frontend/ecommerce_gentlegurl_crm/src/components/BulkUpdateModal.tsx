...
export default function BulkUpdateModal({
  ...
  return show ? (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-xl shadow-lg w-[90%] max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        <div className="shrink-0 space-y-4 px-6 pt-6 pb-4 border-b border-gray-100">
