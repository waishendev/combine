...
export default function BankAccountCreateModal({
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch(`/api/proxy/ecommerce/bank-accounts?type=${workspaceType}`, {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    >
      <form id="bank-account-create-form" onSubmit={handleSubmit} className="space-y-4 px-5 py-4">
