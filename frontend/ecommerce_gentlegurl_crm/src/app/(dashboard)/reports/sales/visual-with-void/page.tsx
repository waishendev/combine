    ...
    <div className="crm-page-shell min-h-0">
      ...
      >
        <Suspense fallback={<div className="p-10 text-sm text-slate-600">Loading report…</div>}>
          <SalesVisualWorkspaceClient canExport={canExport} canUpdateOrder={canUpdateOrder} canVoidRefund={canVoidRefund} canViewStaffReport={canViewStaffReport} includeVoid />
        </Suspense>
      </PosCashShiftGate>
    </div>
  )
