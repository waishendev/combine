...
export default async function BookingSalesPage() {
  ...
  return (
    <div className="overflow-y-auto py-6 px-10">
      <div className="text-xs mb-4">
        ...
        <Link href="/reports/sales/booking" className="text-blue-600 hover:underline">
          Booking Sales
        </Link>
      </div>
      <h2 className="text-3xl font-semibold mb-6">Booking Sales</h2>
      <SalesChannelReportPage mode="booking" canExport={canExport} />
    </div>
  )
}
