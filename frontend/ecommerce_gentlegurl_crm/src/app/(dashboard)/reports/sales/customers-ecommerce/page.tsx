...
export default async function EcommerceCustomerSalesPage() {
  ...
  return (
    <div className="overflow-y-auto py-6 px-10">
      <div className="text-xs mb-4">
        ...
        <Link href="/reports/sales/customers-ecommerce" className="text-blue-600 hover:underline">
          Ecommerce Customer Sales
        </Link>
      </div>
      <h2 className="text-3xl font-semibold mb-6">Ecommerce Customer Sales</h2>
      <CustomerSalesDomainReportPage mode="ecommerce" canExport={canExport} />
    </div>
  )
}
