...
export default async function ServicesPagesPage() {
  ...
  return (
    <div className="overflow-y-auto py-6 px-10">
      ...
      <p className="mb-6 text-sm text-gray-500">
        Manage each services page in one place. Changes only go live after clicking save.
      </p>
      <ServicesPagesEditor permissions={user.permissions} />
    </div>
  )
}
