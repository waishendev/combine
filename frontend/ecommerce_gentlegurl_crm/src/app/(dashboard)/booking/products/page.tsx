  ...
  return (
    <div className="overflow-y-auto py-6 px-10">
      <div className="text-xs mb-4">
        <span className="text-gray-500">{t('booking.breadcrumbSection')}</span>
        <span className="mx-1">/</span>
        <Link href="/booking/products" className="text-blue-600 hover:underline">
          {t('booking.productsTitle')}
        </Link>
      </div>
      <h2 className="text-3xl font-semibold mb-6">{t('booking.productsTitle')}</h2>
