...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $groups = [
            ...
            'ecommerce.landing-page' => 'Ecommerce Landing Page',
            ...
            'ecommerce.rewards.products' => 'Ecommerce Rewards Products',
            ...
            'ecommerce.thermal-printer-settings' => 'Thermal Printer Settings',
        ...
        $definitions = [
            ...
            'ecommerce.landing-page' => ['view', 'update'],
            ...
            'pos' => ['checkout', 'orders.view', 'appointments.manage', 'appointments.checkout', 'staff_consumables.access', 'staff_consumables.checkout', 'staff_consumables.view_logs'],
            ...
            'ecommerce.rewards.products' => ['view'],
            ...
            'ecommerce.thermal-printer-settings' => ['view', 'update'],
            ...
            'booking' => [
                ...
                'services.update',
                'services.delete',
                'question_presets.view',
                'question_presets.create',
                'question_presets.update',
                'question_presets.delete',
                'schedules.view',
                'schedules.create',
                'schedules.update',
                'schedules.delete',
