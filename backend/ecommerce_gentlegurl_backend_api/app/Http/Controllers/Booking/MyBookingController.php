...
class MyBookingController extends Controller
{
    ...
    private function mapCustomerServiceBlocks(Booking $booking): array
    {
        ...
        $originalBlock = [
            ...
            ...$this->resolveCustomerServicePriceMeta(
            ...
            'add_ons' => $originalAddonSource
                ...
                ->map(fn (array $addon) => $this->mapCustomerAddonItem($addon))
                ->values()
                ->all(),
        ];
        ...
        $extraBlocks = $extraMainServiceRows
            ->map(function (array $item) use ($booking, $servicesById) {
                ...
                return [
                    ...
                    ...$this->resolveCustomerServicePriceMeta($item, $linkedService, $booking),
    ...
    private function mapCustomerAddonItem(array $item): array
    {
        ...
        $linkedId = isset($item['linked_booking_service_id']) ? (int) $item['linked_booking_service_id'] : null;
     ...
     */
    private function resolveCustomerServicePriceMeta(array $item, ?BookingService $linkedService, Booking $booking): array
    {
