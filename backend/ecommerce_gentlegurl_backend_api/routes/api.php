...
Route::prefix('/booking')->middleware('api.session')->group(function () {
    ...
    Route::get('/package-cart/payment/callback', [\App\Http\Controllers\Booking\ServicePackageCartController::class, 'callback']);
    ...
    Route::middleware('auth:customer,sanctum')->group(function () {
        ...
        Route::post('/package-cart/add', [\App\Http\Controllers\Booking\ServicePackageCartController::class, 'add']);
        Route::get('/package-cart', [\App\Http\Controllers\Booking\ServicePackageCartController::class, 'show']);
        Route::delete('/package-cart/item/{id}', [\App\Http\Controllers\Booking\ServicePackageCartController::class, 'remove']);
        Route::post('/package-cart/checkout', [\App\Http\Controllers\Booking\ServicePackageCartController::class, 'checkout']);
    });
});
