...
return [
    'product_media' => [
        ...
        // 'video_max_width'  => env('PRODUCT_VIDEO_MAX_WIDTH', 3840),
        // 'video_max_height' => env('PRODUCT_VIDEO_MAX_HEIGHT', 2160),
        'video_max_width'  => env('PRODUCT_VIDEO_MAX_WIDTH', 4096),
        'video_max_height' => env('PRODUCT_VIDEO_MAX_HEIGHT', 2304),
